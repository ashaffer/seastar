...
namespace seastar {
    ...
    public:
        ...
        explicit inline queue(size_t size) : _max(size) {}
        ...
        inline future<T> pop_eventually () {
            if (_ex) {
        ...
        inline future<> push_eventually (T&& data) {
            if (_ex) {
