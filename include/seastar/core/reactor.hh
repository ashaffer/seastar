...
namespace seastar {
    ...
    inline smp_service_group default_smp_service_group() {
        return smp_service_group(0);
    }

    inline unsigned internal::smp_service_group_id(smp_service_group ssg) {
        return ssg._id;
    }
    ...
    public:
        ...
        static constexpr size_t queue_length = 256;
    ...
    public:
        ...
        future<std::optional<directory_entry_type>>  file_type(sstring name, follow_symlink = follow_symlink::yes);
        ...
        void at_destroy(Func&& func) {
            ...
            printf("_q addr: 0x%lx, 0x%lx, 0x%lx, 0x%lx\n", (uint64_t)&_at_destroy_tasks, (uint64_t)&(_at_destroy_tasks->_q), (uint64_t)&(_at_destroy_tasks->_tasks_processed), (uint64_t)&(_at_destroy_tasks->_name));
    ...
    class smp {
        ...
        static std::optional<std::latch> _all_event_loops_done;
    ...
    inline pollable_fd_state::~pollable_fd_state() {
        engine().forget(*this);
    }
