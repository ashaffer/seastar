...
// phys virt_to_phys(const auto* p) {
...
//     for (decltype(auto) bci = begin; bci != end; ++bci) {
//         decltype(auto) bc = *bci;
//         desc pseudo_head = {};
//         desc* prev = &pseudo_head;
        
//         for (decltype(auto) i = bc.begin(); i != bc.end(); ++i) {
...
//             prev = &d;
//         }
//         decltype(auto) desc_head{pseudo_head._next};
...
//                 return transform_iterator{p.fragments().begin(), fragment_to_buffer};
//             }

//             decltype(auto) end() noexcept {
//                 return transform_iterator{p.fragments().end(), fragment_to_buffer};
//             }
